...
const cardData = [
  {
    ...
    description: 'Single Page App that allows users to book gourmet experiences for different cities, and to create new ones that can be available for others, in a quick and easy way. Enjoy your Gourmet Experience!!',
  ...
  },
  {
    ...
    techskills: ['React', 'Redux', 'API Rest', 'JavaScript', 'Mobile Design', 'CSS'],
  ...
  },
  {
    ...
    name: 'TV-themes',
    role: ['SELF-EMPLOYED', 'Full-stack Dev', '2023'],
    description: 'The app displays TV Shows and movie categories libraries upon search input. You will be able to look, like and comment on your favorite shows. Enjoy!!',
    techskills: ['HTML', 'CSS', 'JavaScript', 'API Rest', 'Webpack', 'RWD'],
